...
if ( ! class_exists( 'Pamela_Greene_Art_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Twenty Twenty-One 1.0
	 */
	class Pamela_Greene_Art_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'pamelagreeneart' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'pamelagreeneart' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'pamelagreeneart' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'pamelagreeneart' ),
						'full'    => esc_html__( 'Full text', 'pamelagreeneart' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-pamela-greene-art-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'Pamela_Greene_Art_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Pamela_Greene_Art_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'pamelagreeneart' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
